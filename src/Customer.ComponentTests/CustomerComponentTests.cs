...
using Customer.ComponentTests.SetUp;
using Xunit;
using Xunit.Abstractions;

namespace Customer.ComponentTests
{
    public class CustomerComponentTests : BaseTest, IClassFixture<TestSuiteFixture>
    {
        public CustomerComponentTests(TestSuiteFixture fixture, ITestOutputHelper output)
            : base(
        ...
        /// --> [MemberData(nameof(GetTestCases), "Customer.json")]
